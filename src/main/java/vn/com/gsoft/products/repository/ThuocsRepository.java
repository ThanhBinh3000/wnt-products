...
public interface ThuocsRepository extends BaseRepository<Thuocs, ThuocsReq, Long> {
    @Query("SELECT c FROM Thuocs c " +
            ...
            + " AND (:#{#param.mappingDate} IS NULL OR c.mappingDate >= :#{#param.mappingDateFrom}) "
            + " AND (:#{#param.mappingDate} IS NULL OR c.mappingDate <= :#{#param.mappingDateTo}) "
            ...
            + " AND (:#{#param.userUploadImgDate} IS NULL OR c.userUploadImgDate >= :#{#param.userUploadImgDateFrom}) "
            + " AND (:#{#param.userUploadImgDate} IS NULL OR c.userUploadImgDate <= :#{#param.userUploadImgDateTo}) "
