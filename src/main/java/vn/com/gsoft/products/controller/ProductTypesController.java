...
@Slf4j
@RestController
@RequestMapping(PathContains.URL_PRODUCT_TYPES)
public class ProductTypesController {
  ...
  public ResponseEntity<BaseResponse> colection(@RequestBody ProductTypesReq objReq) throws Exception {
  ...
  @ResponseStatus(HttpStatus.OK)
  public ResponseEntity<BaseResponse> colectionList(@RequestBody ProductTypesReq objReq) throws Exception {
  ...
  public ResponseEntity<BaseResponse> insert(@Valid @RequestBody ProductTypesReq objReq) throws Exception {
  ...
  @ResponseStatus(HttpStatus.CREATED)
  public ResponseEntity<BaseResponse> update(@Valid @RequestBody ProductTypesReq objReq) throws Exception {
  ...
  @ResponseStatus(HttpStatus.OK)
  public ResponseEntity<BaseResponse> delete(@Valid @RequestBody ProductTypesReq idSearchReq) throws Exception {
